...
## Cosmic Baryon Cycle
In a very simple terms the ["cosmic baryon cycle"](https://arxiv.org/abs/2011.01935) is very similar to the how evaporation and rain works on the earth. We all know that sun heats up the water on earth which evaporates and and goes up where it condenses and forms clouds which in turn shower rain on earth. This process continues and we call it water cycle in hydrology. Similarly, the pristine gas (mostly hydrogen and helium) is accreted (also known as the inflow) by the galactic halo (CGM) where it forms gaseous clouds (a very complex physical mechanism) which falls on galactic disk where it is turned into stars. Finally, these stars release a lot of energy via supernovae or stellar winds which kicks gas out of the galaxy into the halo (CGM) (known as the galactic outflows). This whole process also makes the CGM very multiphase in nature where gas with different temparature and densities compete with each other. Will the galaxy continue getting fuel and form new stars or will it stop forming stars, depend on the balance between these gas flows. However, this is extremely challenging to predict or fully understand the fate of galaxy formation!
